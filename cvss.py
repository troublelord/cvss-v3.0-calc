...
cvssWeight={'AV':{'N':0.85,'A':0.62,'L':0.55,'P':0.2},'AC':{'H':0.44,'L':0.77},'PR':{'U':{'N':0.85,'L':0.62,'H':0.27},'C':{'N':0.85,'L':0.68,'H':0.5}},'UI':{'N':0.85,'R':0.62},'S':{'U':6.42,'C':7.52},'CIA':{'N':0,'L':0.22,'H':0.56}}
...
def cvss_calc(cvss):
	...
	if(cvss[0].split(':')[1]=='3.0'):
		...
		iscBase = 1 - ( ( 1 - cvssWeight['CIA'][cvssDict['C']] ) * ( 1 - cvssWeight['CIA'][cvssDict['I']] ) *  ( 1 - cvssWeight['CIA'][cvssDict['A']] ) )
